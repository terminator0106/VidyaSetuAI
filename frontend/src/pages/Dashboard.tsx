      ...
      <header className="sticky top-0 z-40 border-b border-border bg-background/90 backdrop-blur-md">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant="ghost" className="h-10 px-4 text-base" onClick={() => { void logout().finally(() => navigate('/')); }}>
            ...
            (() => {
              ...
              return (
                <motion.div
                  ...
                  onClick={() => navigate(`/subject/${encodeURIComponent(subject.id)}`)}
                ...
                >
                  <div className="mb-4 flex items-start justify-between">
                    ...
                    <span className="rounded-full bg-muted px-3 py-1 text-xs font-medium text-muted-foreground">{chaptersCount} chapters</span>
                  </div>
          ...
          {showAdd ? (
            ...
            >
              ...
              <div className="flex gap-3">
                <Button className="h-11 px-6 text-base" onClick={handleAdd}>Add</Button>
                <Button className="h-11 px-6 text-base" variant="ghost" onClick={() => setShowAdd(false)}>Cancel</Button>
              </div>
            </motion.div>
          ) : (
            <motion.button
