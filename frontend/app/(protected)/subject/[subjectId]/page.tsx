            ...
            <div className="mx-auto max-w-7xl px-6 py-10">
                ...
                <div className="rounded-2xl border border-border bg-card p-8 mb-10">
                    ...
                    <p className="mb-6 text-base text-muted-foreground">
                        Upload a textbook PDF. The backend will automatically split it into per-chapter PDFs.
                    </p>
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                        ...
                        <Button
                            ...
                            className="h-12 px-8 text-base sm:w-44"
                        >
                                ...
                                <div key={tb.id} className="rounded-2xl border border-border bg-card overflow-hidden">
                                    ...
                                    <div className="divide-y divide-border">
                                        {tb.chapters.map((ch) => (
                                            <div
                                                key={ch.id}
                                                className="flex flex-col gap-3 px-8 py-5 sm:flex-row sm:items-center sm:justify-between hover:bg-muted/30 transition-colors"
                                            >
                                                <div>
                                                ...
                                                <Button
                                                    ...
                                                    onClick={() => router.push(`/chapter/${encodeURIComponent(ch.id)}`)}
                                                    disabled={!ch.pdfUrl}
                                                >
                                                    Open Chapter
                                                </Button>
